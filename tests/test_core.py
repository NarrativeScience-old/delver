...
from context import core as mod_ut, exceptions, handlers
...
class TestDelver(unittest.TestCase):
    ...
    def test__build_prompt(self):
        """Test the prompt appropriately contains the index descriptor"""
        obj_ut = mod_ut.Delver(self.obj)
    ...
    def test__handle_input__basic_input(self):
        ...
        new_basic_input_map = {"do-the-thing": fake_do_thing}
        obj_ut = mod_ut.Delver(self.obj)
    ...
    def test__handle_input__obj_handler_normal(self):
        ...
        fake_do_thing = mock.Mock()
        new_basic_input_map = {"basic-doer": (fake_do_thing, 0)}
        obj_ut = mod_ut.Delver(self.obj)
        obj_ut._basic_input_map = new_basic_input_map

        result = obj_ut._handle_input("custom-thing", {"foo": "bar"}, fake_obj_handler)
    ...
    def test__handle_input__obj_handler_catch_exceptions(self, fake_print):
        ...
        input_obj = {"foo": "bar"}
        result = obj_ut._handle_input("custom-thing", input_obj, fake_obj_handler)
        fake_handle_input.assert_called()
